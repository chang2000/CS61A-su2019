...
def couple(lst1, lst2):
    """Return a list that contains lists with i-th elements of two lists
    coupled together. Try using a list comprehension.
...
def closer_city(lat, lon, city1, city2):
    ...
    mindis = min(distance(new_city, city1), distance(new_city, city2))
    if distance(new_city, city1) == mindis:
